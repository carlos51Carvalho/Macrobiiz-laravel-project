...
@section('conteudo')
    ...
    <div class="content-wrapper">
        <form method="POST" action="gravar_vencimento" id="postnormal" enctype="multipart/form-data" style="display: block;">
        {{-- csrf --}}
        {{ csrf_field() }}
        ...
        <section class="content-header">
            <div class="row">
                <div class="col-6">
                    <h4>Adicionar Vencimento</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <button class="btn btn-success btn-sm teste" role="submit" style="margin-left: 0.5em;"><i class="fas fa-save"></i> Gravar  </button></a>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        ...
                                                        @if(count($colaborador) == 0)
                                                            <p class = "alert alert-danger">Não existem colaboradores para associar vencimentos</p>
