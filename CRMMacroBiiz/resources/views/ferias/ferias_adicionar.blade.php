...
@section('conteudo')
    ...
    <div class="content-wrapper">
        <form method="POST" action="gravar_ferias" id="postnormal" enctype="multipart/form-data" style="display: block;">
        {{-- csrf --}}
        {{ csrf_field() }}
        ...
        <section class="content-header">
            <div class="row">
                <div class="col-6">
                    <h4>Adicionar ferias</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a href="marcacao_ferias/{{$colaborador->id}}"><button class="btn btn-success btn-sm teste" role="submit" style="margin-left: 0.5em;"><i class="fas fa-save"></i> Gravar  </button></a>
