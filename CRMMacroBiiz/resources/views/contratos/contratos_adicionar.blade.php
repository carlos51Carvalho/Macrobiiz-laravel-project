...
@section('conteudo')
    ...
    <div class="content-wrapper">
        <form method="POST" action="gravar_contrato" id="postnormal" enctype="multipart/form-data" style="display: block;">
        {{-- csrf --}}
        {{ csrf_field() }}
                                                ...
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        ...
                                                        @if(count($colaborador) == 0)
                                                            <p class = "alert alert-danger">Não existem colaboradores para associar contratos</p>
