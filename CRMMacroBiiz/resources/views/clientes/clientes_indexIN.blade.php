    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                {{-- <a href="/"><button class="btn btn-success" style="margin-left: 0.5em;" role="submit"><i class="fas fa-lightbulb-off-fill"></i></button></a> --}}
                <a href="/"><button class="btn btn-success" style="margin-left: 0.5em; padding: 10px;" role="submit"><i class="fas fa-lightbulb"></i></button></a>
