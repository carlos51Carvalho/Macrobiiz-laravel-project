...
@section('conteudo')
    ...
    <div class="content-wrapper">
        <form method="POST" action="/atualizar_despesa/{{$despesa->id_despesa}}" id="postnormal" enctype="multipart/form-data" style="display: block;">
        {{-- csrf --}}
        {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a href="javascript:history.back()"><button class="btn btn-success btn-sm" role="submit" style="margin-left: 0.5em;"><i class="fas fa-save"></i> Gravar  </button></a>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        ...
                                                        @if(count($colaborador) == 0)
                                                            <p class = "alert alert-danger">Não existem colaboradors para associar despesas</p>
                                                        ...
                                                        @else
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" id="descricao" name="descricao_text" class="form-control" value="{{$despesa->descricao}}" required>
                                                            </div>

                                                            <div class="form-group col-md-12">
                                                                <label for="data">Data Início</label>
                                                                <input type="date" id="data" name="data_text" class="form-control" value="{{$despesa->data}}" required>
                                                            </div>
