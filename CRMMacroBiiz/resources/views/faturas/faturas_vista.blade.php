            ...
            <div class="row col-12" style="margin-top: 1em;">
                <div class="form-group col-md-12" style="display: flex;">
                  <div class="card-body pad" style="padding: 0;">
                    ...
                    <div>
                    <label for="areanova">Ficheiro: </label>{{$fatura->ficheiro}}
                    </div>
                    <div>
                    <label for="areanova">Data: </label><a>{{Carbon\Carbon::parse($fatura->created_at)->format('Y-m-d')}}</a>
                    </div>
                    <div>
