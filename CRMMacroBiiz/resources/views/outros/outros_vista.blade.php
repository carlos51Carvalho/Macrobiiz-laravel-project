            ...
            <div class="row col-12" style="margin-top: 1em;">
                <div class="form-group col-md-12" style="display: flex;">
                  <div class="card-body pad" style="padding: 0;">
                    ...
                    <div>
                        <label for="areanova">Data Inicio: </label><a>{{Carbon\Carbon::parse($outro->data_inicio)->format('Y-m-d')}}</a>
                    </div>
                    <div>
                        <label for="areanova">Data Fim: </label><a>{{Carbon\Carbon::parse($outro->data_fim)->format('Y-m-d')}}</a>
                    </div>
                    <div>
                        @if ($outro->status == 1)
