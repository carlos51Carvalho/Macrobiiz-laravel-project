...
@section('conteudo')
    ...
    <div class="content-wrapper">
        <form method="POST" action="gravar_faltas" id="postnormal" enctype="multipart/form-data" style="display: block;">
        {{-- csrf --}}
        {{ csrf_field() }}
        ...
        <section class="content-header">
            <div class="row">
                <div class="col-6">
                    <h4>Adicionar faltas</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a href="marcacao_faltas/{{$colaborador->id}}"><button class="btn btn-success btn-sm teste" role="submit" style="margin-left: 0.5em;"><i class="fas fa-save"></i> Gravar  </button></a>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-7">
                                                                ...
                                                                <input type="text" id="descricao" name="descricao_text" class="form-control" value="Injustificada" required>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-7">
                                                                ...
                                                                <input type="number" id="horas" name="horas_text" class="form-control" required>
                                                            </div>
