...
@section('conteudo')
    ...
    <div class="content-wrapper">
        <form method="POST" action="/atualizar_orcamento/{{$orcamento->id_orcamento}}" id="postnormal" enctype="multipart/form-data" style="display: block;">
        {{-- csrf --}}
        {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a href="/index_orcamentos"><button class="btn btn-success btn-sm" role="submit" style="margin-left: 0.5em;"><i class="fas fa-save"></i> Gravar  </button></a>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        ...
                                                        @if(count($cliente) == 0)
                                                            <p class = "alert alert-danger">Não existem clientes para associar orcamentos</p>
                                                        ...
                                                        @else
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" id="descricao" name="descricao_text" class="form-control" value="{{$orcamento->descricao}}" required>
                                                            </div>
